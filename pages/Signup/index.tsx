                        ...
                        <form onSubmit={postUser}>
                            <div className='flex flex-col gap-5 items-center'>
                                ...
                                <div className="flex flex-row w-4/5">
                                    <input type={isVisible ? "text" : "password"} onChange={handleInputChange} name="password" placeholder='Contraseña' className=' w-full h-10   text-center bg-gray-200  rounded-l-md focus:ring-indigo-400 focus-visible:ring' />
                                    <button onClick={() => setVisible(!isVisible)} className="rounded-r-md flex items-center justify-center border border-black -ml-1 bg-gray-200 w-1/5"> {isVisible ? <AiFillEye /> : <AiFillEyeInvisible />} </button>
                                </div>
